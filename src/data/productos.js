...
export const PRODUCTOS = [
  ...
  {
    categoria: "harinas", nombre: "Harina de coco", apto: true, carbos: 8,
    nota: "Absorbe muchísimo líquido: se usa un tercio de lo que pide una receta con harina común.",
  },
  {
    categoria: "harinas", nombre: "Psyllium", apto: true, carbos: 2,
    nota: "El secreto del pan keto que no se desarma. En dietéticas, muy barato.",
  },
  {
    categoria: "harinas", nombre: "Semillas de chía y lino", apto: true, carbos: 2,
    nota: "Fibra y saciedad. La chía en agua reemplaza al huevo en algunas recetas.",
  },
  {
    categoria: "harinas", nombre: "Harina de trigo, avena, pan, fideos, arroz", apto: false, carbos: 70,
    nota: "El corazón de lo que hay que dejar. No hay versión keto de la harina común.",
  },

  // ── Verduras ──────────────────────────────────────────────────────────────
  {
    categoria: "verduras", nombre: "Verduras de hoja (lechuga, espinaca, acelga, rúcula)", apto: true, carbos: 2,
    nota: "Libres. Son el volumen del plato cuando el resto es grasa y proteína.",
  },
  {
    categoria: "verduras", nombre: "Zucchini, berenjena, brócoli, coliflor", apto: true, carbos: 3,
    nota: "El coliflor reemplaza al arroz y al puré. El zucchini, a los fideos.",
  },
  {
    categoria: "verduras", nombre: "Tomate", apto: true, carbos: 3,
    nota: "Entra, pero no en cantidad. Media unidad por comida.",
  },
  {
    categoria: "verduras", nombre: "Frutos rojos (frutilla, arándano)", apto: true, carbos: 6,
    nota: "La única fruta que entra cómoda, y en porción chica.",
  },
  {
    categoria: "verduras", nombre: "Papa, batata, choclo, mandioca", apto: false, carbos: 17,
    nota: "Los cuatro se van del presupuesto de carbos en una porción.",
  },
  {
    categoria: "verduras", nombre: "Banana, uva, mango", apto: false, carbos: 20,
    nota: "Fruta muy dulce. La banana sola puede ser tu día entero de carbos.",
  },

  // ── Bebidas ───────────────────────────────────────────────────────────────
  {
    categoria: "bebidas", nombre: "Mate y té sin azúcar", apto: true, carbos: 0,
    nota: "El mate amargo es keto puro. Con azúcar, no.",
  },
  {
    categoria: "bebidas", nombre: "Café", apto: true, carbos: 0,
    nota: "Solo, o con crema. Con leche suma carbos.",
  },
  {
    categoria: "bebidas", nombre: "Gaseosas zero / sin azúcar", apto: true, carbos: 0,
  ...
  {
    categoria: "bebidas", nombre: "Agua con y sin gas", apto: true, carbos: 0,
    nota: "En keto se pierde más agua y sal: tomá más de lo que tomabas antes.",
  },
  {
    categoria: "bebidas", nombre: "Cerveza", apto: false, carbos: 12,
    nota: "Pura maltosa. Si tomás alcohol, el vino seco o los destilados sin mezclar son menos malos.",
  },
  {
    categoria: "bebidas", nombre: "Jugos y aguas saborizadas comunes", apto: false, carbos: 11,
